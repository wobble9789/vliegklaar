...
export const metadata: Metadata = {
  title: 'Reisbegeleiding voor ouderen in Enschede | Vliegklaar',
  description: 'Persoonlijke reisbegeleiding voor senioren in Enschede. Wij helpen u veilig en comfortabel op reis, van deur tot deur.',
};

export default function EnschedeSEOPage() {
  return (
    <main className="pt-20">
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 text-center md:text-left">
              <h1 className="text-4xl md:text-5xl font-bold text-primary-900 mb-6">
                Reisbegeleiding voor ouderen in Enschede
              </h1>
              <p className="text-xl text-gray-700 mb-8 leading-relaxed">
                Woont u in Enschede of omgeving en wilt u graag op reis, maar ziet u op tegen de logistiek? 
                Vliegklaar biedt persoonlijke begeleiding op maat voor senioren in de regio Twente.
              </p>
            ...
            <div className="flex-1 relative h-[300px] md:h-[400px] w-full rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="https://images.unsplash.com/photo-1549420046-26792f44049e?w=800&q=80"
                alt="Enschede Centrum"
                fill
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-primary-800 mb-8">Waarom kiezen voor Vliegklaar in Enschede?</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-primary-700">✓ Van deur tot deur</h3>
              <p className="text-gray-600">
                Wij halen u thuis op in Enschede (of omgeving zoals Hengelo, Almelo, Oldenzaal) 
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600">
                Onze begeleiders kennen de regio Twente en de route naar Schiphol of Münster-Osnabrück als hun broekzak.
              </p>
            </div>
            <div className="space-y-4">
      ...
      <section className="py-20 bg-primary-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Uw reis start in Enschede</h2>
          <p className="text-xl mb-10 text-primary-100">
            Wilt u de mogelijkheden bespreken voor uw volgende reis? Bel ons voor een vrijblijvend adviesgesprek bij u thuis in Enschede of Twente.
          </p>
          <a
            href="tel:0618769492"
